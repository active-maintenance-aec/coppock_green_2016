...
n_errata <- nrow(spine)
# The note's entries divide by where they came from: the pipeline found the ones a ground
# truth row reaches, an audit of the reference list found the rest.
